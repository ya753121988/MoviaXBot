class script(object):
    START_TXT = """<b><u>👋 হ্যালো বন্ধু 👋</u></b>
...
<blockquote>👇 নিচে দেওয়া বিকল্পগুলি থেকে মুভির সঠিক বানানটি বেছে নিন</blockquote>"""
...
<blockquote>😌 এই মুভিটি আমার ডাটাবেসে পাওয়া যায়নি।</blockquote>"""
...
Mᴇꜱꜱᴀɢᴇ : <b>{}</b>"""
    ...
    CAPTION = """<b><a href="https://t.me/mlswtv">{file_name}</a></b>\n\n<b>⚜️ Powered By : <a href="https://t.me/mlswtv">[ MLSWTV Movie ]</a></b>"""
...
•─────•─────────•─────•
🏷️ <a href='https://t.me/SVFADMINBOT'>ꜱᴜʙꜱᴄʀɪᴘᴛɪᴏɴ ᴘʀᴏᴏꜰ</a>
...
ɪꜰ ʏᴏᴜ ꜰᴀᴄᴇ ᴀɴʏ ᴘʀᴏʙʟᴇᴍ, ᴛᴀᴋᴇ ᴀ ꜱᴄʀᴇᴇɴꜱʜᴏᴛ ᴀɴᴅ ꜱᴇɴᴅ ɪᴛ ᴛᴏ - @SVFADMINBOT
...
<blockquote>আপনার <b>প্রিমিয়াম অ্যাক্সেস</b> সরিয়ে নেওয়া হয়েছে।
আমাদের পরিষেবা ব্যবহার করার জন্য ধন্যবাদ 🥳
আমাদের অন্যান্য প্ল্যানগুলি দেখতে <b>/plan</b> এ ক্লিক করুন।</blockquote>
"""
...
👨‍💻 ᴄᴏɴᴛᴀᴄᴛ ᴛʜᴇ <a href='https://t.me/SVFADMINBOT'>Owner</a> ᴛᴏ ɢᴇᴛ ʏᴏᴜʀ ᴛʀɪᴀʟ.
...
ꜱᴏᴜʀᴄᴇ ᴄᴏᴅᴇ ʜᴇʀᴇ ◉› :<a href=@SVFADMINBOT>MLSWTV</a>\n """
